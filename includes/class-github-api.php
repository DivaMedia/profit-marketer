 ...
 *
 * @package ProfitMarketer_Updater_ProfitMarketer_API
 * @author  Andy Fragen
 */
class ProfitMarketer_Updater_ProfitMarketer_API extends ProfitMarketer_Updater {
	...
	public static function add_headers() {
		add_filter( 'extra_plugin_headers', array( 'ProfitMarketer_Updater_ProfitMarketer_API', 'add_plugin_headers' ) );
		add_filter( 'extra_theme_headers', array( 'ProfitMarketer_Updater_ProfitMarketer_API', 'add_theme_headers' ) );
	}
	...
	public static function add_plugin_headers( $extra_headers ) {
		$ghu_extra_headers     = array(
			'Profit Marketer Plugin URI'   => 'Profit Marketer Plugin URI',
			'Profit Marketer Branch'       => 'Profit Marketer Branch',
			'Profit Marketer Access Token' => 'Profit Marketer Access Token',
		);
	...
	public function get_remote_info( $file ) {
		...
		$this->type->branch         = ( ! empty( $response['Profit Marketer Branch'] ) ? $response['Profit Marketer Branch'] : 'master' );
