 ...
 *
 * @package ProfitMarketer_Updater_Bitbucket_API
 * @author  Andy Fragen
 */
class ProfitMarketer_Updater_Bitbucket_API extends ProfitMarketer_Updater {
	...
	public static function add_headers() {
		add_filter( 'extra_plugin_headers', array( 'ProfitMarketer_Updater_Bitbucket_API', 'add_plugin_headers' ) );
		add_filter( 'extra_theme_headers', array( 'ProfitMarketer_Updater_Bitbucket_API', 'add_theme_headers' ) );
	}
